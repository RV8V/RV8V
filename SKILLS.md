...
| 🟩 Imperative programming      | 🟩 new                | 🟩 Mutable state     |  🟩 Template method       |
| 🟦 Structured programming      | 🟩 Static method      | 🟩 Immutable state   |  🟩 Visitor               |
| 🟦 Non-structured programming  | 🟩 Method             | 🟩 Enum              |  🟩 Composite             |
...
| 🟩 EventEmitter        | 🟩 Blockering operations        | ⬜ Completion ports | ⬜ Web Locks API         |
